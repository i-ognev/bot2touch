...
from keyboards.inline.data_buttons import keyboard_data
from loader import dp


@dp.message_handler(Text(contains="Нужна"))
async def get_cons(message: types.Message):
    ...
    await message.answer("Желаете оставить свои данные?", reply_markup=keyboard_data)


@dp.callback_query_handler(text_contains="желаю")
async def cons_po(call: CallbackQuery):
